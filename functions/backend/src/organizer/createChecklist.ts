...
/**
 * Normalizza un item iniziale ricevuto dal consumer. Un item iniziale può
 * essere una semplice stringa (il titolo) o un oggetto con `title`, `type`
 * e, opzionalmente, `quantity`/`notes`.
 *
